...
class CalendarView:UIViewController,FSCalendarDataSource, FSCalendarDelegate {
    ...
    func CalendarStyle() {
        ...
        calendarView.appearance.selectionColor = .systemYellow
        calendarView.appearance.titleWeekendColor = .black
        calendarView.appearance.titleDefaultColor = .black
        
        calendarView.appearance.titleTodayColor = .systemRed
        calendarView.appearance.todayColor = .clear
        calendarView.appearance.todaySelectionColor = .systemYellow
